...
window.DASHBOARD_DATA = {
  ...
  projects: [
    /* PROJECT:bimpossible:START */
    {
      ...
      waves: {
        ...
        current: [
          ...
          { id: "30", title: "Phase 15e chat assistant gateways — Slack + Microsoft Teams", status: "BUILT", date: "2026-08-08", note: "Slack `dd89889` (#262, merged 2026-08-07), Teams `879e857` (#276, merged 2026-08-08). Read-only Q&A against a bound project + model from a channel, fronting `a…" },
    ...
    /* PROJECT:addins:START */
    {
      ...
      activity: [7,0,0,6,2,0,0,0,0,0,0,0,2,0],
      lastActivity: {
        date: "2026-08-16",
        summary: "feat(pairing): bimpossible://pair browser-to-Revit code handoff (#65) (cdbf22f)"
      },
    ...
    /* PROJECT:bimpossible-workspace:START */
    {
      ...
      activity: [9,20,12,8,12,0,0,0,0,1,2,9,14,0],
      lastActivity: {
        date: "2026-08-16",
        summary: "docs(backup): weekly drill task repaired + scheduled-context proof; workstream closed (#55) (91c1181)"
      },
    ...
    /* PROJECT:dashboard-auto:START */
    {
      ...
      activity: [9,7,3,7,4,2,5,2,3,3,4,3,6,0],
      lastActivity: {
        date: "2026-08-16",
        summary: "bimwatch: 2026-08-17 collection (0c3d6e3)"
      },
