  ...
  projects: [
    /* PROJECT:bimpossible:START */
    {
      ...
      progress: { label: "Program phases", phases: [
        ...
        { name: "P7 Revit Link Write-back (Wave 8)", pct: 35, note: "= Wave 8. Two co-equal engines decided 2026-06-23: DA4R (cloud) + Revit Link (app-sync). write_instance_parameter LIVE (single-user, BIMPOSSIBLE_REVIT_LINK_ENABLED=1 in pilot). Multi-user write-back + DA4R path + sync_with_central re-enable all pending. Gates Phase 9 (Product Data Ingestion).",
          tasks: [
        ...
        { name: "P8 Project Setup Wizard", pct: 60, note: "Onboarding automation — ACC provisioning, folders, central file from template, sheet set, in one click. First BIMpossible feature that WRITES to Autodesk → carries the hard human write-gate. No-write PLANNING slice built + verified 06-14; write path GATED on owner approval. Pull-forward candidate — doesn't depend on the data platform being complete.",
          tasks: [
        ...
        { name: "P11 Model QA & Health", pct: 60, note: "QA-rules engine built 06-14, committed + deployed via PR #142 (2026-06-23). Read-only. Grounded in buildingSMART IDS + Speckle Automate + Solibri severity + Autodesk Model Checker.",
          tasks: [
        ...
        { name: "P12 Content Authoring (placeholder)", pct: 0, note: "Reserved placeholder — multi-prerequisite gated. Future tier above parameter writeback: product spec → content resolution → model action pipeline. Depends on Phase 4 (Assistant) substantial + Phase 5.2 (Sheets) + write-back runtime decision.",
          tasks: [
      ...
      waves: {
        ...
        current: [
          ...
          },
          {
            ...
            status: "PLANNED",
            note: "= Program Phase 7 (Revit Link Write-back). write_instance_parameter live (single-user). DA4R co-equal engine proposed 2026-06-23. Multi-user + DA4R + sync_central pending. Gates Phase 9."
          },
          {
            id: "15",
