...
window.DASHBOARD_DATA = {
  ...
  projects: [
    /* PROJECT:bimpossible:START */
    {
      ...
      activity: [19,3,36,8,50,28,0,0,6,39,49,20,1,0],
      lastActivity: {
        date: "2026-09-14",
    ...
    /* PROJECT:addins:START */
    {
      ...
      activity: [0,0,0,0,3,6,0,0,29,12,2,6,0,0],
      lastActivity: {
        date: "2026-09-13",
    ...
    /* PROJECT:aiserver:START */
    {
      ...
      activity: [0,0,0,0,0,29,0,0,1,6,19,12,0,0],
      lastActivity: {
        date: "2026-09-13",
      ...
      recent: [
        "Endpoint up · models: gemma4:26b-a4b-it-q4_K_M (snapshot 06:57)",
    ...
    /* PROJECT:bimpossible-workspace:START */
    {
      ...
      activity: [8,2,15,4,19,26,0,0,3,16,26,14,1,0],
      lastActivity: {
        date: "2026-09-14",
        summary: "audit(weekly): full audit 2026-09-14 — report, breach chains, ledger, Checklist WSR64/65, run log (735c779)"
      },
    ...
    /* PROJECT:dashboard-auto:START */
    {
      ...
      activity: [16,3,3,3,5,18,3,3,6,3,5,12,4,1],
      lastActivity: {
        date: "2026-09-15",
        summary: "chore: live billing sync 2026-09-15 (60c033a)"
      },
