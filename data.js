...
window.DASHBOARD_DATA = {
  ...
  projects: [
    /* PROJECT:bimpossible:START */
    {
      ...
      activity: [62,19,3,36,8,50,28,0,0,6,39,49,20,0],
      lastActivity: {
        date: "2026-09-13",
    ...
    /* PROJECT:addins:START */
    {
      ...
      activity: [2,0,0,0,0,3,6,0,0,29,12,2,6,0],
      lastActivity: {
        date: "2026-09-13",
    ...
    /* PROJECT:aiserver:START */
    {
      ...
      activity: [0,0,0,0,0,0,29,0,0,1,6,19,12,0],
      lastActivity: {
        date: "2026-09-13",
    ...
    /* PROJECT:bimpossible-workspace:START */
    {
      ...
      activity: [37,8,2,15,4,19,26,0,0,3,16,26,14,0],
      lastActivity: {
        date: "2026-09-13",
        summary: "chore(queue): add UX-SHARED-WITH-YOU-TITLE-IS-SHARE-LABEL + UX-RECENTLY-OPENED-EPOCH-DATE as landed — PR #664 merged ea32beee, deployed 2026-09-14 00:05Z; live flip waits on S&L grantee visual check (6a8df67)"
      },
    ...
    /* PROJECT:dashboard-auto:START */
    {
      ...
      activity: [3,16,3,3,3,5,18,3,3,6,3,5,12,2],
      lastActivity: {
        date: "2026-09-14",
        summary: "chore: live billing sync 2026-09-14 (221d535)"
      },
